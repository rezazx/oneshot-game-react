...
function App() {
    ...
    useEffect(()=>{
        ...
        enemyInrval.current=setInterval(()=>{
            ...
            setLevel(parseInt(game.enemies.length/5)+1);
        },100);
    ...
    return (
        <GameContext.Provider value={{game,setGame,score,setScore,gameStatus,setGameStatus}}>
            <h2 className="Info"><div>Score:<b>{score}</b></div>  <div>Level:<b>{level}</b></div> </h2>
